...
**A6** 3 zip codes, each with 6, 3 and 4 loans respectively. Someone put in the wrong information in either the Race category or on the ZCTA end. Either way it's most likely a human error. 
