...
```{r}
# Load data
md_loans <- read_csv("data/ppp_loans_md.csv")
...
**Answer** Certain cities are capitalized differently or misspelled. 
...
**Answer** Made PHOENIX = Phoenix and WESTMINSTER = Westminster
...
**Answer** Change Aberdeen to all be title case, fixed the case but not the splling. 
...
**Answer** Does some things but not everything. Pretty similar to key_collision_merge.
...
```{r}
refine_md_loans <- read_csv("data/Maryland-PPP.csv")
