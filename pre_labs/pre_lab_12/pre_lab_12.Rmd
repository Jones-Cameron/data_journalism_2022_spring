...
**Answer** County vaccionations by date. Shows date and time of vaccination date by County in maryland. Shows number of first dose, second dose and cumulative dose.
...
**Answer** Some of the numbers are different. Why would that be?
...
**Answer** Looking at data where no county is listed.
...
**Answer** Ranks all the PG County tests. 
...
**Answer** Count peaks in april and then declines and stays way lower after around July 2021. 
...
**Answer** COVID cases by county in Maryland over time.
...
**Task** Run the following code and describe what the resulting chart shows
**Answer** Used a log scale to make chart easier to read. Shows a more consistent increase
