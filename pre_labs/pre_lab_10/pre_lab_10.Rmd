...
**Answer** Copy the url of the graphic you published here. https://datawrapper.dwcdn.net/Srk7n/1/
...
**Answer** Describe what the code below is doing and the output. Group by project county name and count the number of loans in each county. 
...
**Answer** Describe what the code below is doing and the output. Cleaning for counties that have greater than 6 loans, as there were some unwanetd counties in the dataframe. 
...
**Answer** Describe the contents of the new `fips_code` column. Has the state and county code together in a fips code column.
...
**Answer** Describe here what you see in `md_counties_with_fips`. Joining the two columns together so we have count, fips code, and loans. 
...
**Answer** Describe the changes from the previous map. The map is now only zoomed in on the regions with data. Therefore just maryland. 
...
**Answer** Describe the changes from the previous map. Counts the number of loans per county in the map.
...
**Answer** Put the URL of your map here. https://datawrapper.dwcdn.net/47asp/1/
