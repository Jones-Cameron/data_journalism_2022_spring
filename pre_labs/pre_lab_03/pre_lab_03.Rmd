...
**Answer**: 135073, yes it's the same number
...
**Answer**: 135073, yes, the two values are the same meaning forgiveness amount and the date of forgiveness are directly correlated.
...
**Answer** Not sure of loan amount. Reicived an error. 
```{r}
ppp_maryland_loans %>%
...
**Answer** column headers inconsistently styled, duplicated row, and city field have different forms
...
**Answer** adds an x infront and makes name lowercase
...
**Answer** Error in h(simpleError(msg, call)) :, Something wrong with the summarise code
