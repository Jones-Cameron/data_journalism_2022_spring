...
**Answer** Creates a new dataframe, groups by count and then summarizes the data by the top 10 counties by loan amount. 
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** I see a bar graph with the 10 different counties.
...
**Answer** The counties are in ascending order by amount, but the x axis is still scrambled.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** the coord_flip() command has flipped the axes.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** We used the theme_minimal() command to get rid of the gray background. 
...
**Answer** We added the theme "economist" which changed the font and background color of the graph, the overall theme has been reformatted. 
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** Changed x axis to simplify it, and corrected the y axis, as well as added a title and caption to the graph. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** There is a list of the amount of loans approved ordered by date
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** we have a line chart with the total loans and date apporved of the loans
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** See more specific date breaks.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** Turn them 45 degrees using "element_text"
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
