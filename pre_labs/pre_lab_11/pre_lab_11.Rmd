...
**Answer** Load a lot of files on hospitals
...
**Answer** Address, city, date, zip code, etc...
...
**Answer** It only shows Maryland hospitals
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Shows the kind of hospitals
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Only shows General Acute Care hospitals
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Plotted them on a longitude latitude grid.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** have a list of all counties
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** got a gg plot of counties
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Have the hospitals on the map 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Color of points let people know which hospitals have the most beds
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** general acute hospitals loaded in
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** arrange by county and total beds
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** get total counties in maryland and popualtion data
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** get maryland counties population
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** rename column to county so the two can join
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** calculating number of beds per population
