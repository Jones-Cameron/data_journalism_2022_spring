...
**Answer** Dataframe with all tweets mentioning COVID or coronavirus
...
**Answer** Makes it so words will be recognized as the same regardless of capitalization. 
...
**Answer** Seperates all unique words into their own columns
...
**Answer** Shows the most commonly used words in all COVID related tweets. The results are unsurprising.
...
**Answer** Much more interesting. It filtered out words like "the" and other words commonly used in any tweet
...
**Answer** We have most commonly used words in 2020 and 2021 seperated. Vaccine is extremely prominent in 2021 considering its not mentioned in 2020
...
**Task** Run the following code and describe the results.
**Answer** Covid 19 and health care are the most common two word phrases from 2020. 
...
**Task** Run the following code and describe the results.
**Answer** covid 19 and 19 vaccine are the most common phrases in 20221, which makes perfect sense bc of the prominence of the vax. 
...
**Task** Run the following code and describe the results.
**Answer** Two dataframes. Pandemic seems more common among republicans
...
**Task** Run the following code and describe the results.
**Answer** Compared the House Candidates and one year mentions trump a lot whereas the other doesn't mention him much at all. 
...
**Answer** They all seem fair. Trump and positive sentiment seems like it could be inaccurate. 
